...
export default function RegisterPage() {
  ...
  return (
  <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4 pt-16 sm:pt-20 pb-12 sm:pb-16">
      <motion.div
